...
<body class="easyui-layout">
		...
		<table style="padding-top: 10px">
			<tr>
				...
				<td><select id="teacherCourse" class="easyui-combogrid"
					name="courseId" style="width: 230px;" panelHeight="auto"
					data-options="
			panelWidth: 500,
			idField: 'courseId',
			...
			columns: [[
				...
				{field:'courseName',title:'课程名',width:60},
				{field:'optional',title:'是否选修',width:40}
			]],
			fitColumns: true,
	...
	<div data-options="region:'center'">
		<table id="dg" class="easyui-datagrid"
			...
			<thead>
				...
				<th data-options="field:'studentName',width:50">学生姓名</th>
	...
	<script type="text/javascript">
		...
		function courseSelected(value) {
			courseInfoId = value;
			$('#dg').datagrid({
				url : 'getCourseStudentScores.action?id=' + courseInfoId
			});
		...
		function saveStudentScoreData() {
			...
			$
					.post(
							'updateStudentCourseScores.action',
							{
